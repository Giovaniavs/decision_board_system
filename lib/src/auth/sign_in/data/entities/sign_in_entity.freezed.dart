...
/// @nodoc
@JsonSerializable()
class _$_SignInEntity extends _SignInEntity {
  const _$_SignInEntity({this.data, this.token}) : super._();
  ...
  @override
  String toString() {
    return 'SignInEntity(data: $data, token: $token)';
  }
...
abstract class _SignInEntity extends SignInEntity {
  const factory _SignInEntity({final String? data, final String? token}) =
      _$_SignInEntity;
  const _SignInEntity._() : super._();
